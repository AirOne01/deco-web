...
const CompassButton = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ asChild = false, ...props }, ref) => {
    ...
    return (
      <Link href="/heads">
        <Comp
          className="group h-10 flex items-center justify-start gap-2 bg-[rgb(161,255,20)] text-[rgb(19,19,19)] font-semibold relative cursor-pointer duration-[0.2s] shadow-[5px_5px_10px_rgba(0,0,0,0.116)] duration-[0.5s] p-2 pr-2.5 rounded-[30px] border-[none] hover:bg-[rgb(192,255,20)] hover:duration-[0.5s] active:duration-[0.2s] active:scale-[0.97]"
          ref={ref}
          {...props}
        >
